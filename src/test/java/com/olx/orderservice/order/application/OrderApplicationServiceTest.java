package com.olx.orderservice.order.application;
...
import com.olx.orderservice.order.application.service.SortStrategyRegistry;
...
import com.olx.orderservice.order.application.service.NewestFirstStrategy;
...
class OrderApplicationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new OrderApplicationService(orderRepository, sortStrategyRegistry);
    }
    ...
    void shouldListOrdersWithPagination() {
        ...
        when(sortStrategyRegistry.getStrategy("newest"))
            .thenReturn(new NewestFirstStrategy());
